...
def feat_func6( x, y ):
    ...
    i = x[3]
    w = x[2][i]
    org = ["Microsoft","Sony","Alcatel","Google","Apple","Blackberry","Asus","Hp", "Htc", "Intel", "Lenovo", "Lava", "Karbonn", "Lg", "Moto", "Micromax", "Nokia", "Motorola", "Oneplus", "Obi", "Samsung", "Spice", "Xiaomi", "Xolo", "Yu", "Zen", "Zte", "Vivo"]
    if( w[0].isupper() and w in org and y == "ORGANIZATION" ):
        return 1
    return 0
